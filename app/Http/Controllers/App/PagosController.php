...
class PagosController extends Controller
{
    ...
    public function confirmacion(int $id)
    {
        ...
        try
        {
            ...
            $response = $client->request('POST', '/api/session/' . $req->requestId, ['json' => $json_array]);
    ...
    public function crearTransaccion()
    {
        ...
        try
        {
            ...
            $json = json_encode($request);
            $json_array = json_decode($json);
            $response = $client->request('POST', '/api/session', ['json' => $json_array]);
            ...
            $req->product = $request->buyer->product;
